...
"SELECT projects.category, pledges.amount FROM projects LEFT OUTER JOIN pledges ON pledges.project_id = projects.id WHERE projects.category = 'music' ORDER BY pledges.id;"
end
